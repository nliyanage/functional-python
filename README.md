# Functional Python [![](https://github.com/nliyanage/functional-python/workflows/tests/badge.svg)](https://github.com/nliyanage/functional-python/actions?query=workflow%3Atests)
